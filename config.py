...
OUTPUT_REPO = "P2SAMAPA/p2-etf-fokker-planck-results"
...
GRID_POINTS = 50            # discretisation points for density grid
EPSILON = 1e-6              # regularisation for entropy calculation
TOP_N = 3
